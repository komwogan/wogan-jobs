! function() {
    ...
    function e() {
        var o = '<div class="browser-error-dialog s-edit-modal" style="display:block; position: fixed; background-color:#e7e9eb ; width: 70%; left: 15%; bottom: 50px; text-align: center;"><p style="padding: 30px; font-size: 140%;"><strong><span>${tips}</span><a href="${learnMoreURL}" target="_blank">${learnMoreText}</a></strong></p></div>';
        return o
    }
    ...
    function n(o, e) {
        var n = -1,
            r = null;
        return o && o.indexOf("MSIE") !== -1 ? r = new RegExp("MSIE ([0-9]{1,}[.0-9]{0,})") : e && "Netscape" === e && o.indexOf("Trident") !== -1 && (r = new RegExp("Trident/.*rv:([0-9]{1,}[.0-9]{0,})")), r && null !== r.exec(o) && (n = window.parseInt(RegExp.$1)), n
    }

    function r(o) {
        var e = -1,
            n = null;
        return o && o.indexOf("Windows NT") !== -1 && (n = new RegExp("Windows NT ([0-9]{1,}[.0-9]{0,});")), n && null !== n.exec(o) && (e = window.parseInt(RegExp.$1)), e
    }
        ...
        if (!$(".browser-error-dialog").length) {
            ...
            $(window).scroll(function() {
                window.clearTimeout(d), d = window.setTimeout(function() {
                    w = 0 !== document.body.scrollTop ? document.body.scrollTop : $(window).scrollTop(), $(".browser-error-dialog").animate({
                        bottom: p - w
                    }, "slow")
                }, 150)
            })
