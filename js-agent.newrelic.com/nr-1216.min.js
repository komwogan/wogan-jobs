! function(t, e, n) {
    ...
    3: [function(t, e, n) {
        ...
        var d = t(19),
            ...
            w = t(45),
            x = 0,
            T = b.getConfiguration("ssl") === !1 ? "http" : "https";
    ...
    4: [function(t, e, n) {
        ...
        function i() {
            function t(t) {
                return "undefined" == typeof t || "" === t ? "" : (t = String(t), f.shouldObfuscate() && (t = f.obfuscateString(t)), d.call(e, t) ? o(e[t], !0) : (e[t] = n++, s(t)))
            }
    ...
    10: [function(t, e, n) {
        function r(t) {
            if (t.info.beacon) {
                ...
                if (n) {
                    var r = "1",
                        o = [h(t)];
                    if (o.push(n), o.push(w.param("tt", t.info.ttGuid)), o.push(w.param("us", t.info.user)), o.push(w.param("ac", t.info.account)), o.push(w.param("pr", t.info.product)), o.push(w.param("af", y(t.features, function(t) {
                            return t
                        }).join(","))), window.performance && "undefined" != typeof window.performance.timing) {
                        var i = {
                            timing: b.addPT(window.performance.timing, {}),
                            navigation: b.addPN(window.performance.navigation, {})
                        };
                        o.push(w.param("perf", x(i)))
                    }
                    if (window.performance && window.performance.getEntriesByType) {
                        var a = window.performance.getEntriesByType("paint");
                        a && a.length > 0 && a.forEach(function(t) {
                            !t.startTime || t.startTime <= 0 || ("first-paint" === t.name ? o.push(w.param("fp", String(Math.floor(t.startTime)))) : "first-contentful-paint" === t.name && o.push(w.param("fcp", String(Math.floor(t.startTime)))), B(t.name, Math.floor(t.startTime)))
                        })
                    }
                    ...
                    T.jsonp(I + "://" + t.info.beacon + "/" + r + "/" + t.info.licenseKey + u, N)
                }
            }
        }

        function o(t) {
            var e = y(q, function(e) {
                return s(e, t, {
                    unload: !0
                })
            });
        ...
        function a(t, e) {
            for (var n = v(), r = v(), o = q[t] && q[t] || [], i = 0; i < o.length; i++) {
                var a = o[i](e);
                a && (a.body && y(a.body, n), a.qs && y(a.qs, r))
            }
            return {
                body: n(),
                qs: r()
        ...
        function s(t, e, n, r) {
            ...
            if (!o) return !1;
            var i = {
                retry: o.method === T.xhr
            };
            return C.shouldObfuscate() ? c(t, e, a(t, i), n, o, r) : f(t, e, a(t, i), n, o, r)
        }

        function u(t, e, n, r, o, i) {
            var a = v(),
                s = v();
            n.body && y(n.body, a), n.qs && y(n.qs, s);
            var u = {
                    body: a(),
                    qs: s()
                },
                d = C.shouldObfuscate() ? c : f;
            return d(t, e, u, r, o, i)
        }

        function c(t, e, n, r, o, i) {
            return M(n, C.obfuscateString, "string", ["e"]), f(t, e, n, r, o, i)
        }
        ...
        function f(t, e, n, r, o, i) {
            ...
            r || (r = {});
            var a = I + "://" + e.info.errorBeacon + "/" + t + "/1/" + e.info.licenseKey + h(e);
            n.qs && (a += w.obj(n.qs, e.maxBytes)), o || (o = d(t, r));
            var s, u = o.method,
                c = o.useBody,
                f = a;
            c && "events" === t ? s = n.body.e : c ? s = x(n.body) : f = a + w.obj(n.body, e.maxBytes);
            var l = u(f, s);
            if (i && u === T.xhr) {
                var p = l;
                p.addEventListener("load", function() {
                    ...
                    429 === this.status ? (t.retry = !0, t.delay = U) : 408 !== this.status && 500 !== this.status && 503 !== this.status || (t.retry = !0), r.needResponse && (t.responseText = this.responseText), i(t)
                }, L(!1))
            }
            return l || u !== T.beacon || (u = T.img, l = u(a + w.obj(n.body, e.maxBytes))), l
        }
        ...
        function d(t, e) {
            ...
            if (e.needResponse) {
                if (!_) return !1;
                r = !0, n = T.xhr
            } else if (e.unload) r = P, n = P ? T.beacon : T.img;
            else if (_) r = !0, n = T.xhr;
            else {
        ...
        function h(t) {
            ...
            var n = R(k.getLocation()),
                r = C.shouldObfuscate() ? C.obfuscateString(n) : n;
            return ["?a=" + t.info.applicationID, w.param("sa", t.info.sa ? "" + t.info.sa : ""), w.param("v", O), l(t), w.param("ct", t.customTransaction), "&rst=" + t.now(), "&ck=" + (e ? "1" : "0"), w.param("ref", r), w.param("ptid", t.ptid ? "" + t.ptid : "")].join("")
        }
        ...
        var g = t(21),
            ...
            R = t(5),
            C = t(16),
            M = t(27).applyFnToProps,
            O = "1216.487a282",
            N = "NREUM.setToken",
            q = {},
            P = !!navigator.sendBeacon,
            U = A.getConfiguration("harvest.tooManyRequestsDelay") || 60,
            I = A.getConfiguration("ssl") === !1 ? "http" : "https",
            H = t(11),
            _ = H > 9 || 0 === H,
            B = t(17).addMetric,
            L = t(42);
    ...
    16: [function(t, e, n) {
        ...
        function o() {
            var t = [],
                e = s.getConfiguration("obfuscate") || [];
            return t = t.concat(e), c.isFileProtocol() && t.push(f), t
        }

        function i(t) {
            for (var e = !1, n = !1, r = 0; r < t.length; r++) {
                "regex" in t[r] ? "string" != typeof t[r].regex && t[r].regex.constructor !== RegExp && (console && console.warn && console.warn('An obfuscation replacement rule contains a "regex" value with an invalid type (must be a string or RegExp)'), n = !0) : (console && console.warn && console.warn('An obfuscation replacement rule was detected missing a "regex" value.'), n = !0);
                var o = t[r].replacement;
                o && "string" != typeof o && (console && console.warn && console.warn('An obfuscation replacement rule contains a "replacement" value with an invalid type (must be a string)'), e = !0)
            }
            return !e && !n
        }
        ...
        function a(t) {
            ...
            for (var e = o(), n = t, r = 0; r < e.length; r++) {
                var i = e[r].regex,
                    a = e[r].replacement || "*";
                n = n.replace(i, a)
            }
        ...
        r() && u.recordSupportability("Generic/Obfuscate/Detected"), r() && !i(o()) && u.recordSupportability("Generic/Obfuscate/Invalid"), e.exports = {
            obfuscateString: a,
            shouldObfuscate: r,
            getRules: o,
            validateRules: i
    ...
    18: [function(t, e, n) {
        ...
        var o = t(29).getWindow,
            i = t(45),
            a = {
                isFileProtocol: r,
                supportabilityMetricSent: !1
            };
        e.exports = a, r() && (i.recordSupportability("Generic/FileProtocol/Detected"), a.supportabilityMetricSent = !0)
    }, {}],
    19: [function(t, e, n) {
        function r(t, e, n, r) {
            o(r || i, t, e, n)
    ...
    26: [function(t, e, n) {
        ...
        function o() {
            if (!N && null !== q) {
                ...
                n && (n["net-type"] && (r["net-type"] = n["net-type"]), n["net-etype"] && (r["net-etype"] = n["net-etype"]), n["net-rtt"] && (r["net-rtt"] = n["net-rtt"]), n["net-dlink"] && (r["net-dlink"] = n["net-dlink"])), t.url && (r.elUrl = R(t.url)), t.element && t.element.tagName && (r.elTag = t.element.tagName), (e > 0 || P) && (r.cls = e), c("lcp", Math.floor(t.startTime), r, !1), N = !0
            }
        }
        ...
        function a(t) {
            ...
            }), I.value += t.value, I.lastEntryTime = Math.max(I.lastEntryTime, t.startTime), U < I.value && (U = I.value)
        }

        function s(t) {
            H || (c("pageHide", t, null, !0), H = !0)
        }
        ...
        function d(t) {
            if (t.retry && O.length > 0) {
                for (var e = 0; e < O.length; e++) M.push(O[e]);
                O = []
            }
        }
        ...
        function m(t) {
            if (0 !== M.length) {
                var e = h(M);
                if (t.retry)
                    for (var n = 0; n < M.length; n++) O.push(M[n]);
                return M = [], {
                    body: {
                        e: e
                    }
        ...
        function h(t) {
            for (var e = b(), n = "bel.6;", r = 0; r < t.length; r++) {
                var o = t[r];
    ...
    27: [function(t, e, n) {
        function r(t, e, n, r) {
            function o(t) {
                for (var r in t) t.hasOwnProperty(r) && ("object" == typeof t[r] ? o(t[r]) : typeof t[r] !== n || i(r) || (t[r] = e(t[r])));
                return t
            }
            ...
            return t && "object" == typeof t ? (n = n || "string", r = r || [], o(t)) : t
        }
        e.exports = {
            applyFnToProps: r
        }
    ...
    33: [function(t, e, n) {
        function r(t) {
            ...
            var n = {
                ...
                r = S(g.releaseIds);
            return "{}" !== r && (n.qs.ri = r), e && e.err && e.err.length && !O && (n.qs.pve = "1", O = !0), n
        }
        ...
        function f(t, e, n, r) {
            ...
            if (e = e || g.now(), n || !g.onerror || !g.onerror(t)) {
                ...
                a.message && (f.message = "" + a.message), b[f.stackHash] ? f.browser_stack_hash = v(a.stackString) : (b[f.stackHash] = !0, f.stack_trace = C(a.stackString)), f.releaseIds = S(g.releaseIds);
                var d = i(f);
        ...
        if (t(22), g.features.err) {
            var O = !1,
                N = R.getConfiguration("jserrors.harvestTimeSeconds") || 60;
    ...
    35: [function(t, e, n) {
        ...
        var s, u, c = t("ee"),
            ...
            g = t(41),
            y = 240,
            b = g.getConfiguration("ins.harvestTimeSeconds") || 30,
            w = y * b / 60,
            x = [],
    ...
    36: [function(t, e, n) {
        ...
        function m(t, e) {
            if (!(B >= D)) {
                var n = _[t];
                n || (n = _[t] = []), _[t] = e.concat(n), B += e.length
            }
        }

        function h(t) {
            N() || f(window.performance.getEntriesByType("resource"));
            var e = R(A(_, function(t, e) {
                return t in I ? R(A(R(e.sort(v), g(t), {}), y), b, []) : e
            }), b, []);
        ...
        function T(t, e) {
            var n = u(t.target, e);
            return t.type in U.global || !!(U[n] && t.type in U[n])
        }
        var E = t("loader"),
            S = t(19),
            j = t(10),
        ...
        if (j.xhrUsable && E.xhrWrappable) {
            ...
            if (e.exports = {
                ...
                z.on("feat-stn", function() {
                    function t(t) {
                        t.sent && t.responseText && !P && (P = t.responseText, E.ptid = P, n.startTimer(F)), t.sent && t.retry && L && (A(L, function(t, e) {
                            m(t, e)
                        }), L = null)
                    }
    ...
    39: [function(t, e, n) {
        ...
        function o(t, e, n, r, o) {
            ...
            if (i = v(t.cat ? [t.status, t.cat] : [t.status, t.host, t.pathname]), E("bstXhrAgg", ["xhr", i, t, e]), p.store("xhr", i, t, e), d()) {
                if (!A(t)) return void C(t.hostname === x.info.errorBeacon ? "Ajax/Events/Excluded/Agent" : "Ajax/Events/Excluded/App");
                var a = this,
                    s = {
                        method: t.method,
                        status: t.status,
        ...
        function i(t) {
            ...
            for (var e = a(M, t.maxPayloadSize || P), n = [], r = 0; r < e.length; r++) n.push({
                body: {
                    e: e[r]
                }
            });
            return t.retry && (N = M.slice()), M = [], n
        }
        ...
        function s(t) {
            t.retry && N.length > 0 && d() && (M = M.concat(N), N = [])
        }
        ...
        function f(t) {
            this.addString = b(), this.events = t, this.payload = "bel.7;";
            for (var e = 0; e < this.events.length; e++) {
                var n = this.events[e],
                    ...
                    o = "2,",
                    i = w(x.info.jsAttributes || {}, this.addString);
        ...
        var l, p = t(2),
            ...
            j = t(9),
            k = t(38).setDenyList,
            A = t(38).shouldCollectEvent,
            R = t(28),
            C = t(45).recordSupportability,
            M = [],
            O = {},
            N = [];
        if (x.features.xhr) {
            ...
            d() && k(S.getConfiguration("ajax.deny_list")), T.on("feat-err", function() {
                ...
                O[t.id] && delete O[t.id]
            }), T.on("interactionDiscarded", function(t) {
                O[t.id] && d() && (O[t.id].forEach(function(t) {
                    M.push(t)
                }), delete O[t.id])
            })
        }
    ...
    44: [function(t, e, n) {
        function r() {
            var t = [];
            try {
                o() && t.push(s.REACT), i() && t.push(s.ANGULARJS), a() && t.push(s.ANGULAR), window.Backbone && t.push(s.BACKBONE), window.Ember && t.push(s.EMBER), window.Vue && t.push(s.VUE), window.Meteor && t.push(s.METEOR), window.Zepto && t.push(s.ZEPTO), window.jQuery && t.push(s.JQUERY)
            } catch (e) {}
            return t
        }
