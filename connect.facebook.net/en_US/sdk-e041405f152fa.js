/*1662204036,,JIT Construction: v1006140878,en_US*/
...
try {
                    ...
                    function a() {
                        function a(a, b) {
                            ...
                            try {
                                ...
                                var e = a.host;
                                a = a.pathname;
                                c = e === b.host && ES(a, "includes", !0, "/rsrc.php/")
                            } catch (a) {
                        ...
                        function b(b) {
                            var c = h.getEntriesByType("resource").filter(function(c) {
                                    return a(c, new URL(b))
                                }),
                                d = c.length >= 1;
                            d || (c = h.getEntriesByType("resource").filter(function(a) {
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1006140878","namespace":"FB","message":"' + e.message + '"}}');
